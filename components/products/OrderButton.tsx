  ...
  return (
    <div className="space-y-5">
      ...
      <a
        ...
        className="flex items-center justify-center gap-3 w-full bg-green-500 hover:bg-green-400 text-white font-bold py-4 px-6 rounded-2xl transition-colors text-base mt-2"
      >
        <svg
          width="22"
          height="22"
      ...
      <p className="text-xs text-center text-gray-400">
        Délai de livraison estimé : 3 à 4 semaines après confirmation
      </p>
    </div>
  );
}
